...
import { ListMusic, Play, ChevronDown } from 'lucide-react';
...
export default function Playlists() {
  ...
  const currentPlaylistId =
    current?.kind === 'playlist' ? current.item.playlistId : null;
    ...
    <div className="container mx-auto px-4 py-8 pb-52 min-h-[100dvh]">
      ...
      <div className="mb-8">
        ...
        <p className="text-muted-foreground">
          Tap a playlist to play it directly in the app.
        </p>
      </div>
          ...
          {isLoading
            ...
            ? playlists.map((playlist, i) => (
                <PlaylistCard
                  ...
                  playlist={playlist}
                  index={i}
                  isPlaying={currentPlaylistId === playlist.playlistId}
                  onPlay={() => play({ kind: 'playlist', item: playlist })}
                />
              ))
            : (
